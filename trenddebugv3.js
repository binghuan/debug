...
function messageHandler(event) {
	...
	case ACTION_OF_TEST.RESULT_GET_DPV3_STATUS:
        ...
        if(document.getElementById("accountType") != undefined) {
		...
		// ### check Pin state
        console.log('isMasterpinOk: ', event.message.isMasterpinOk);
        if(document.getElementById("pinStatus") != undefined) {
        ...
        console.log('isMasterpinTableExist: ', event.message.isMasterpinTableExist);
        if(document.getElementById("pintableStatus") != undefined) {
        ...
        console.log('loginStatus: ', event.message.loginStatus);
        if(document.getElementById("loginStatus") != undefined) {
            document.getElementById("loginStatus").innerHTML = erroCode;
            mappingLoginStatusErrorMsg(erroCode);
        }

		// ### check User Settings
        console.log('userSetting: ', event.message.userSetting);
        if(document.getElementById("userSettings") != undefined) {
            document.getElementById("userSettings").innerText = JSON.stringify(event.message.userSetting, null, 4);
        }

        console.log('accountID: ', event.message.accountID);
        if( document.getElementById("accountIdNow") != undefined) {
...
function runTest() {
    ...
    //if(document.getElementById("online_fail") != undefined) {
    ...
    if(document.getElementById("timestamp") != undefined) {
        document.getElementById("timestamp").innerHTML = (new Date()).toString();
    }

	console.log('#4');
    if(document.getElementById("typeOfPlatform") != undefined) {
        if(mobilecheck() === true) {
